export const Values = () => (
  <section id="valores" className="overflow-hidden bg-indigo-600 pb-36 pt-32">
    <div className="container mx-auto px-8 lg:px-4">
      <div>
        <h2 className="xl:text-10xl max-xs:text-4xl mb-9 text-6xl font-bold leading-none tracking-tight text-white md:text-8xl">
        ...
        <p className="mb-16 text-xl leading-relaxed text-gray-200">
          ...
          é possível sem comprometer a qualidade de nossas entregas.
        </p>
      </div>
