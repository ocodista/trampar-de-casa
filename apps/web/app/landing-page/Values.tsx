export const Values = () => (
  <section id="valores" className="pt-32 pb-36 bg-indigo-600 overflow-hidden">
    <div className="container px-8 lg:px-4 mx-auto">
      <div>
        <h2 className="mb-9 text-6xl md:text-8xl xl:text-10xl text-white font-bold tracking-px-n leading-none max-xs:text-4xl">
          Apoiamos a liberdade do trabalho remoto.
        </h2>
        <p className="mb-16 text-gray-200 leading-relaxed">
      ...
      <div className="flex flex-wrap -m-3">
          ...
          >
            <div className="flex flex-wrap flex-col gap-3">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-semibold">Software Livre</h3>
              </div>
              ...
              <p className="text-gray-600 font-medium leading-relaxed">
                ...
                . Se você simpatiza com a ideia de adoção do modelo de trabalho
                remoto,{' '}
                <span className="text-indigo-600 group-hover:brightness-110">
        ...
        <div className="w-full md:w-1/2 p-3">
          <div className="h-full p-7 bg-white border border-gray-900 rounded-3xl">
            <div className="flex flex-wrap flex-col gap-3">
              <div className="flex items-center gap-3">
                <div className="w-8">
                  <svg
