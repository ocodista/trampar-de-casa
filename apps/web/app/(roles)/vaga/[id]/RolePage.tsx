...
import { LoginRoleModal } from 'app/components/LoginRoleModal'
...
const translations = {
  en: {
    ...
    errorCheckingProfile: 'Error checking profile',
  ...
  pt: {
    ...
    errorCheckingProfile: 'Erro ao verificar perfil',
    tryAgainLater: 'Tente novamente mais tarde',
  },
}

const getJobDetails = (role, t) => {
  const details = [
    {
  ...
  details.push({
    ...
    label: t.postedOn,
    value: formatDate(role.updatedAt, role.language),
  })
...
export const RolePage = ({ role }) => {
  ...
  const jobDetails = useMemo(() => getJobDetails(role, t), [role, t])
