...
export const metadata = {
  ...
  description: 'Descubra como Sam Alves transformou a BPTech adotando o trabalho remoto, promovendo flexibilidade e eficiência. Uma visão detalhada sobre a transição para regimes híbridos e remotos, superando desafios e impulsionando o crescimento.',
  ...
  openGraph: {
    ...
    description: 'Descubra como Sam Alves transformou a BPTech adotando o trabalho remoto, promovendo flexibilidade e eficiência. Uma visão detalhada sobre a transição para regimes híbridos e remotos, superando desafios e impulsionando o crescimento.', // Optional: if you want a different description for OG
...
<ArticleHeader timeToRead={8} author={metadata.author} title={metadata.title} role="Manager na BPTech" quote="Em 21 dias conseguimos fechar todas as vagas que precisávamos graças ao trabalho remoto" dateText="12 de fevereiro, 2024" />
