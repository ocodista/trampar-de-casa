export const skillArray = [
  ...
  { id: 12, name: 'AngularJS', normalized: 'ANGULARJS' },
  ...
  { id: 28, name: 'CSS3', normalized: 'CSS3' },
  ...
  { id: 60, name: 'HTML5', normalized: 'HTML5' },
  ...
  { id: 69, name: 'Kotlin', normalized: 'KOTLIN' },
  { id: 70, name: 'Laravel', normalized: 'LARAVEL' },
  ...
  { id: 107, name: 'SaaS Sales', normalized: null },
  { id: 108, name: 'Sales Analytics', normalized: null },
  { id: 109, name: 'Sales Closing', normalized: null },
  { id: 110, name: 'Sales Enablement', normalized: null },
  { id: 111, name: 'Sales Forecasting', normalized: null },
  { id: 112, name: 'Sales Management', normalized: null },
  { id: 113, name: 'Sales Operations', normalized: null },
  { id: 114, name: 'Sales Process', normalized: null },
  { id: 115, name: 'Sales Strategy', normalized: null },
  { id: 116, name: 'Salesforce', normalized: null },
  { id: 117, name: 'Scala', normalized: null },
  { id: 118, name: 'Scrum', normalized: null },
  { id: 119, name: 'Sketch', normalized: null },
  { id: 120, name: 'Social Media Marketing', normalized: null },
  { id: 121, name: 'Strategic Planning', normalized: null },
  { id: 122, name: 'Swift', normalized: null },
  { id: 123, name: 'Team Building', normalized: null },
  { id: 124, name: 'Technical Writing', normalized: null },
  { id: 125, name: 'Telesales', normalized: null },
  ...
  { id: 133, name: 'Vue.js', normalized: 'VUE' },
  ...
  { id: 148, name: 'Vue.js', normalized: 'VUE' },
  { id: 149, name: 'Astro.js', normalized: 'ASTRO' },
  { id: 150, name: 'Svelte', normalized: 'SVELTE' },
  { id: 151, name: 'Ember.js', normalized: 'EMBER' },
  { id: 152, name: 'Next.js', normalized: 'NEXT' },
  { id: 153, name: 'Express.js', normalized: 'EXPRESS' },
  { id: 154, name: 'Meteor.js', normalized: 'METEOR' },
  { id: 155, name: 'Nest.js', normalized: 'NEST' },
  { id: 156, name: 'Aurelia', normalized: 'AURELIA' },
  { id: 157, name: 'Remix.js', normalized: 'REMIX' },
  { id: 158, name: 'Core Java', normalized: 'COREJAVA' },
  { id: 159, name: 'Java SE', normalized: 'JAVASE' },
  { id: 160, name: 'Java EE', normalized: 'JAVAEE' },
  ...
  { id: 170, name: 'Spring Core', normalized: 'SPRINGCORE' },
  { id: 171, name: 'Spring MVC', normalized: 'SPRINGMVC' },
  { id: 172, name: 'Spring Boot', normalized: 'SPRINGBOOT' },
  { id: 173, name: 'Spring Data', normalized: 'SPRINGDATA' },
  { id: 174, name: 'Spring Security', normalized: 'SPRINGSECURITY' },
  { id: 175, name: 'Hibernate ORM', normalized: 'HIBERNATEORM' },
  { id: 176, name: 'Struts Framework', normalized: 'STRUTSFRAMEWORK' },
  { id: 177, name: 'JavaServer Faces', normalized: 'JAVASERVERFACES' },
  ...
  { id: 190, name: 'Java Persistence', normalized: 'JAVAPERSISTENCE' },
  { id: 191, name: 'Java Messaging', normalized: 'JAVAMESSAGING' },
  ...
  { id: 198, name: 'Java Security', normalized: 'JAVASECURITY' },
  { id: 199, name: 'Kotlin Language', normalized: 'KOTLINLANGUAGE' },
  { id: 200, name: 'Scala Language', normalized: 'SCALALANGUAGE' },
  { id: 201, name: '.NET Framework', normalized: 'NETFRAMEWORK' },
  { id: 202, name: '.NET Core', normalized: 'NETCORE' },
  { id: 203, name: '.NET 5', normalized: 'NET5' },
  { id: 204, name: '.NET 6', normalized: 'NET6' },
  { id: 205, name: 'ASP.NET Core', normalized: 'ASPNETCORE' },
  ...
  { id: 215, name: 'Amazon EC2', normalized: 'AMAZONEC2' },
  {
    ...
    normalized: 'AMAZONEC2AUTOSCALING',
  },
  ...
  { id: 310, name: 'Web3.js', normalized: 'WEB3JS' },
  ...
  { id: 392, name: 'ITIL Framework', normalized: 'ITILFRAMEWORK' },
  {
    id: 393,
